...
class ShareViewController: SLComposeServiceViewController {
    ...
    override func viewDidLoad() {
        ...
        let containerURL = FileManager().containerURL(forSecurityApplicationGroupIdentifier: "group.ShareDemo.SahreDemoExtension")!
        ...
        self.present(alertView, animated: true, completion: {
                    ...
                    itemProvider.loadItem(forTypeIdentifier: kUTTypeData as String, options: nil) { data, error in
                        if error == nil {
                            ...
                            if let imageData = try? Data(contentsOf: url) {
                                if let prefs = UserDefaults(suiteName: "group.ShareDemo.SahreDemoExtension") {
            ...
            group.notify(queue: DispatchQueue.main) {
                ...
                do {
                    ...
                    let result = self.openURL(URL(string: "ImageSharing://\(jsonString!)")!)
                } catch {
